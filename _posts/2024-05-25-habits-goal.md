...
description: Our work on synergizing habits and goals was published in Nature Communications.
header: One paper published in Nature Communications!
lang: en
title_zh: 一篇论文发表于 Nature Communications
excerpt_zh: 我们用变分贝叶斯框架统一解释习惯性行为与目标导向行为。
alternate_url: /zh/news/habits-goal/
---
